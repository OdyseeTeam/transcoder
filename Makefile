...
tower_image_latest:
	docker buildx build -f Dockerfile-tower -t odyseeteam/transcoder-tower:latest --platform linux/amd64 --push .

worker_image_latest:
	docker buildx build -f Dockerfile-worker -t odyseeteam/transcoder-worker:latest --platform linux/amd64 --push .
